				...
				<div class="panel panel-default" id="teapanelbox">
					<div class="pane input-group" id="panel-head">
						<div class="input-group" id="inputgroups">
							...
							<input type="text" class="form-control" placeholder="请输入姓名或工号" id="inputsearch" value="" /> 
				...
				<div class="">
					<table class="table table-bordered table-hover" id="scoretable">
						<thead>
							...
							<th class="text-center"><nobr>学院/部门</nobr></th>
						...
						<tbody>
							<tr>
								...
								<td class="text-center"><nobr>21001</nobr></td>
								<td class="text-center"><nobr>张三</nobr></td>
							...
							<tr>
								...
								<td class="text-center"><nobr>21002</nobr></td>
								<td class="text-center"><nobr>李四</nobr></td>
								<td class="text-center"><nobr>男</nobr></td>
								<td class="text-center"><nobr>行政部</nobr></td>
								<td class="text-center">
									<button class="btn btn-default btn-sm btn-warning"
										style="height:28px" value="${obj.classid }">
										<span class="glyphicon glyphicon-del" id="search">删除</span>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<table class="table table-hover">
							<tbody>
								<tr>
									<td id="regLable"><label class="control-label">请输入工号:</label>
									</td>
								...
								<tr>
									<td id="regLable"><label class="control-label">请选择学院或部门:</label>
									</td>
									<td><select id="select" name="select"
										class="selectpicker show-tick form-control">
