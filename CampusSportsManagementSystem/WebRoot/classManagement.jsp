				...
				<div class="panel panel-default" id="teapanelbox">
					<div class="pane input-group" id="panel-head">
						<div class="input-group" id="inputgroups">
							...
							<input type="text" class="form-control" placeholder="请输入班级名称" id="inputsearch" value="" /> 
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<table class="table table-hover">
							<tbody>
								<tr>
									<td id="regLable"><label class="control-label">学院:</label>
									</td>
								...
								<tr>
									<td id="regLable"><label class="control-label">专业:</label>
									</td>
									<td><select id="select" name="select"
										class="selectpicker show-tick form-control">
								...
								<tr>
									<td id="regLable"><label class="control-label">班级名称:</label>
									</td>
									<td><input type="text" class="form-control input-sm input"
										id="username" name="username" placeholder="请输入班级名称" /> <span
