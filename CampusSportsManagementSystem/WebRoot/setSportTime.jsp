				...
				<div class="panel panel-default" id="teapanelbox">
					<div class="pane input-group" id="panel-head">
						<div class="input-group" id="inputgroups">
							<input type="text" class="form-control" placeholder="请输入赛事名称或时间" id="inputsearch" value="" /> 
				...
				<div class="">
					<table class="table table-bordered table-hover" id="scoretable">
						<thead>
							...
							<th class="text-center"><nobr>赛事名称</nobr></th>
						...
						<tbody>
							<tr>
								...
								<td class="text-center"><nobr>2017秋季运动会</nobr></td>
								<td class="text-center"><nobr>2017-9-15</nobr></td>
								<td class="text-center"><nobr>2017-9-25</nobr></td>
							</tr>
							
							<tr>
								<!--<td class="text-center"><input type="checkbox" /></td> -->
								<td class="text-center"><nobr>2</nobr></td>
								<td class="text-center"><nobr>2016秋季运动会</nobr></td>
								<td class="text-center"><nobr>2016-9-15</nobr></td>
								<td class="text-center"><nobr>2016-9-25</nobr></td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">添加赛事信息</h4>
					</div>
					<div class="modal-body">
						<table class="table table-hover">
							<tbody>
								<tr>
									<td id="regLable"><label class="control-label">赛事名称:</label>
									</td>
									<td><input type="text" class="form-control input-sm input"
										id="username" name="username" placeholder="请输入赛事名称" /> <span
