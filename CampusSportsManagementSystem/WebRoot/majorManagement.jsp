				...
				<div class="panel panel-default" id="teapanelbox">
					<div class="pane input-group" id="panel-head">
						<div class="input-group" id="inputgroups">
							...
							<input type="text" class="form-control" placeholder="请输入专业名称" id="inputsearch" value="" /> 
					...
					<div class="modal-body">
						<table class="table table-hover">
							<tbody>
								...
								<tr>
									<td id="regLable"><label class="control-label">专业名称:</label>
									</td>
									<td><input type="text" class="form-control input-sm input"
										id="username" name="username" placeholder="请输入专业名称" /> <span
