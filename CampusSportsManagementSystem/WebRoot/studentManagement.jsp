				...
				<div class="panel panel-default" id="teapanelbox">
					<div class="pane input-group" id="panel-head">
						<div class="input-group" id="inputgroups">
							...
							<select class="selectpicker selectcollegeId" data-width="auto"
								id="selectcollegeId">
								<option value="0">-查询所有班级-</option>
								<c:forEach items="${collegelist}" var="collegeobj">
									<option value="${collegeobj.collegeid}">${collegeobj.collegename}</option>
								</c:forEach>
							</select>  
							<input type="text" class="form-control" placeholder="请输入学生姓名或学号" id="inputsearch" value="" /> 
					...
					<table class="table table-bordered table-hover" id="scoretable">
						...
						<tbody>
							<tr>
								...
								<td class="text-center"><nobr>166122001</nobr></td>
							...
							<tr>
								...
								<td class="text-center"><nobr>166122002</nobr></td>
								<td class="text-center"><nobr>贾三</nobr></td>
								<td class="text-center"><nobr>男</nobr></td>
								<td class="text-center"><nobr>信息工程学院</nobr></td>
								<td class="text-center"><nobr>计算机科学与技术</nobr></td>
								<td class="text-center"><nobr>2016级计算机科学与技术1班</nobr></td>
								<td class="text-center">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<table class="table table-hover">
							<tbody>
								<tr>
									<td id="regLable"><label class="control-label">请输入学号:</label>
									</td>
									<td><input type="text" class="form-control input-sm input"
										id="username" name="username" placeholder="请输入学号" /> <span
										id="validateName"></span></td>
								</tr>
								<tr>
									<td id="regLable"><label class="control-label">请输入姓名:</label>
									</td>
									<td><input type="text" class="form-control input-sm input"
										id="username" name="username" placeholder="请输入姓名" /> <span
										id="validateName"></span></td>
								</tr>
								<tr>
									<td id="regLable"><label class="control-label">请选择性别:</label>
									</td>
								...
								<tr>
									<td id="regLable"><label class="control-label">请选择学院:</label>
									</td>
									<td><select id="select" name="select"
										class="selectpicker show-tick form-control">
								...
								<tr>
									<td id="regLable"><label class="control-label">请选择专业:</label>
									</td>
									<td><select id="select" name="select"
										class="selectpicker show-tick form-control">
								...
								<tr>
									<td id="regLable"><label class="control-label">请选择班级:</label>
									</td>
									<td><select id="select" name="select"
										class="selectpicker show-tick form-control">
											<option value="">2016级计算机科学与技术1班</option>
											<option value="">2016级计算机科学与技术2班</option>
									</select></td>
								</tr>
							</tbody>
						</table>
